...
const ExtendedSubjectContentsecond = () => {
  return (
    <>
                          ...
                          <div className="mb-4">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <ul className="list-disc pl-6">
                                      ...
                                      <li>bearing</li>
                                      <li>right angle</li>
                                      <li>acute, obtuse and reflex angles</li>
                                      <li>interior and exterior angles</li>
                                      <li>similar</li>
                                      <li>congruent</li>
                                      <li>scale factor</li>
                                  </ul>
                                  <li>2 Use and interpret the vocabulary of:</li>
                                  <ul className="list-disc pl-6">
                                      <li>triangles</li>
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start">
                      <div className="flex-1 min-h-[100px] p-4">
                          <div className="mb-4">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  <li>Use and interpret the vocabulary of a circle.</li>
                              </ul>
                          </div>
                      </div>
                      <div className="flex-1 min-h-[100px] p-4">
                          <div className="mb-4">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  <li>Polygons:</li>
                                  <ul className="list-disc pl-6">
                                      <li>regular and irregular polygons</li>
                                      <li>pentagon</li>
                                      <li>hexagon</li>
                                      <li>octagon</li>
                                      <li>decagon.</li>
                                  ...
                                  <ul className="list-disc pl-6">
                                      <li>centre</li>
                                      <li>radius (plural radii)</li>
                                      <li>diameter</li>
                                      <li>circumference</li>
                                      <li>semicircle</li>
                                      <li>chord</li>
                                      <li>tangent</li>
                                      <li>major and minor arc</li>
                                      <li>sector</li>
                                      <li>segment.</li>
                                  </ul>
                              </ul>
                  ...
                  <h2 className="text-xl font-semibold mb-2 text-headingcol">4 Geometry (continued)</h2>
                          ...
                          <div className="flex-1 min-h-[100px] p-4">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <li>2 Construct a triangle, given the lengths of all sides, using a ruler and pair of compasses only.</li>
                          ...
                          <div className="flex flex-col md:flex-row justify-between items-start">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <li>2 Use the relationships between lengths and areas of similar shapes and lengths, surface areas and volumes of similar solids.</li>
                          ...
                          <div className="flex flex-col md:flex-row justify-between items-start">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <li>e.g. construct a rhombus by drawing two triangles. Construction arcs must be shown.</li>
                                  <li>Examples include:</li>
                                  <ul className="list-disc pl-6">
                                      <li>draw nets of cubes, cuboids, prisms and pyramids</li>
                                      <li>use measurements from nets to calculate volumes and surface areas.</li>
                                  </ul>
                              </ul>
                          </div>
                              <div className="flex-1 min-h-[100px] p-4">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <li>Includes an understanding of the terms north, east, south and west.</li>
                          ...
                          <div className="flex flex-col md:flex-row justify-between items-start">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <li>Volume of A / Volume of B = (Length of A / Length of B)³</li>
                  ...
                  <h2 className="text-xl font-semibold mb-2 text-headingcol">4 Geometry (continued)</h2>
                          ...
                          <div className="flex flex-col md:flex-row justify-between items-start">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <ul className="list-disc pl-6">
                                      <li>sum of angles at a point = 360°</li>
                                      <li>sum of angles at a point on a straight line = 180°</li>
                                      <li>vertically opposite angles are equal</li>
                                      <li>angle sum of a triangle = 180° and angle sum of a quadrilateral = 360°.</li>
                                  </ul>
                                  <li>2 Calculate unknown angles and give geometric explanations for angles formed within parallel lines: </li>
                                  <ul className="list-disc pl-6">
                                      <li>corresponding angles are equal</li>
                                      <li>alternate angles are equal</li>
                                      <li>co-interior angles sum to 180° (supplementary).</li>
                                  </ul>
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <ul className="list-disc pl-6">
                                      ...
                                      <li>angle between tangent and radius = 90°</li>
                                      <li>angle at the centre is twice the angle at the circumference</li>
                                      <li>angles in the same segment are equal</li>
                                      <li>opposite angles of a cyclic quadrilateral sum to 180° (supplementary)</li>
                      ...
                      <div className="flex flex-col md:flex-row justify-between items-start">
                          <div className="flex-1 min-h-[100px] p-4">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <ul className="list-disc pl-6">
                                      <li>equal chords are equidistant from the centre</li>
                                      <li>the perpendicular bisector of a chord passes through the centre</li>
                  ...
                  <h2 className="text-xl font-semibold mb-2 text-headingcol">5 Mensuration</h2>
                          ...
                          <div className="flex flex-col md:flex-row justify-between items-start">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <li>Conversion between units includes:</li>
                                  <ul className="list-disc pl-6">
                                      <li>between different units of area, e.g. cm² → m²</li>
                                      <li>between units of volume and capacity, e.g. m³ → litres.</li>
                                  </ul>
                              </ul>
                          </div>
                              <div className="flex-1 min-h-[100px] p-4">
                          ...
                          <div className="flex flex-col md:flex-row justify-between items-start">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <ul className="list-disc pl-6">
                                      <li>curved surface area of a cylinder</li>
                                      <li>curved surface area of a cone</li>
                                      <li>surface area of a sphere</li>
                                      <li>volume of a prism</li>
                                      <li>volume of a pyramid</li>
              ...
              <div className="section mb-6">
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start">
                      <div className="flex-1">
                          <div className="mb-4">
                              <h3 className="text-lg font-semibold bg-red-100">E5.5 Compound shapes and parts of shapes</h3>
                              <ul className="list-disc pl-6 text-gray-600">
                                  <li>1 Carry out calculations and solve problems involving perimeters and areas of:</li>
                                  <ul className="list-disc pl-6">
                                      <li>compound shapes</li>
                                      <li>parts of shapes.</li>
                                  </ul>
                                  <li>2 Carry out calculations and solve problems involving surface areas and volumes of:</li>
                                  <ul className="list-disc pl-6">
                                      <li>compound solids</li>
                                      <li>parts of solids.</li>
                                  </ul>
                              </ul>
                          </div>
                      </div>
                      <div className="flex-1">
                          <div className="mb-4">
                              ...
                              <ul className="list-disc pl-6">
                                  <li>e.g. find the surface area and volume of a frustum.</li>
                              </ul>
                          </div>
                      </div>
                  </div>
                  ...
                  <h2 className="text-xl font-semibold mb-2 text-headingcol">6 Trigonometry</h2>
                          ...
                          <div className="flex flex-col md:flex-row justify-between items-start">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <li>3 Know that the perpendicular distance from a point to a line is the shortest distance to the line.</li>
                          ...
                          <div className="flex flex-col md:flex-row justify-between items-start">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <ul className="list-disc pl-6">
                                      <li>sin x and cos x for x = 0°, 30°, 45°, 60° and 90°.</li>
                                      <li>tan x for x = 0°, 30°, 45° and 60°.</li>
                                  </ul>
                              </ul>
                          </div>
                              <div className="flex-1 min-h-[100px] p-4">
                      ...
                      <div className="flex flex-col md:flex-row justify-between items-start">
                          ...
                          <div className="flex-1 min-h-[100px] p-4">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <li>2 Use the formula</li>
                                  <ul className="list-disc pl-6">
                                      <li>area of triangle = ½absinC.</li>
                                  </ul>
                              </ul>
                          </div>
                          <div className="flex-1 min-h-[100px] p-4">
                  ...
                  <h2 className="text-xl font-semibold mb-2 text-headingcol">7 Transformations and Vectors</h2>
                          ...
                          <div className="flex flex-col md:flex-row justify-between items-start">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <ul className="list-disc pl-6">
                                      <li>Reflection of a shape in a straight line.</li>
                                      <li>Rotation of a shape about a centre through multiples of 90°.</li>
                                      <li>Enlargement of a shape from a centre by a scale factor.</li>
                                      <li>Translation of a shape by a vector [x, y].</li>
                                  </ul>
                              </ul>
                          </div>
                              <div className="flex-1 min-h-[100px] p-4">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <li>2 Add and subtract vectors.</li>
                          ...
                          <div className="flex flex-col md:flex-row justify-between items-start">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <li>2 Use position vectors.</li>
                                  <li>3 Use the sum and difference of two or more vectors to express given vectors in terms of two coplanar vectors.</li>
                          ...
                          <div className="flex flex-col md:flex-row justify-between items-start">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <ul className="list-disc pl-6">
                                      <li>|a| is the magnitude of a</li>
                                      <li>|AB| is the magnitude of AB.</li>
                                  </ul>
                              </ul>
                          </div>
                              <div className="flex-1 min-h-[100px] p-4">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  <li>Examples include:</li>
                                  <ul className="list-disc pl-6">
                                      <li>show that vectors are parallel</li>
                                      <li>show that 3 points are collinear</li>
                                      <li>solve vector problems involving ratio and similarity.</li>
                                  </ul>
                              </ul>
                          </div>
                  ...
                  <h2 className="text-xl font-semibold mb-2 text-headingcol">8 Probability</h2>
                          ...
                          <div className="flex flex-col md:flex-row justify-between items-start">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <li>2 Understand and use probability notation.</li>
                                  <li>3 Calculate the probability of a single event.</li>
                          ...
                          <div className="flex flex-col md:flex-row justify-between items-start">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <li>The notation P(A∩B) and P(A∩B&apos;) may be used in the context of Venn diagrams.</li>
                  ...
                  <h2 className="text-xl font-semibold mb-2 text-headingcol">9 Statistics</h2>
                          ...
                          <div className="flex flex-col md:flex-row justify-between items-start">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <li>2 Compare sets of data using tables, graphs and statistical measures.</li>
                          ...
                          <div className="flex flex-col md:flex-row justify-between items-start">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <li>2 Calculate an estimate of the mean for grouped discrete or grouped continuous data.</li>
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <ul className="list-disc pl-6">
                                      ...
                                      <li>(b) pie charts</li>
                                      <li>(c) pictograms</li>
                                      <li>(d) stem-and-leaf diagrams</li>
                                      <li>(e) simple frequency distributions.</li>
                                  </ul>
                              </ul>
                          </div>
                  ...
                  <h2 className="text-xl font-semibold mb-2text-headingcol text-headingcol">9 Statistics (continued)</h2>
                          ...
                          <div className="flex flex-col md:flex-row justify-between items-start">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <li>2 Understand what is meant by positive, negative and zero correlation.</li>
                      ...
                      <div className="flex flex-col md:flex-row justify-between items-start">
                          ...
                          <div className="flex-1 min-h-[100px] p-4">
                              ...
                              <ul className="list-disc pl-6 text-gray-600">
                                  ...
                                  <ul className="list-disc pl-6">
                                      <li>should be a single ruled line drawn by inspection</li>
                                      <li>should extend across the full data set</li>
                                      <li>does not need to coincide exactly with any of the points but there should be a roughly even distribution of points either side of the line over its entire length.</li>
                                  </ul>
                              </ul>
                          </div>
                          <div className="flex-1 min-h-[100px] p-4">
...
export default ExtendedSubjectContentsecond