                              ...
                              <ul className="list-disc ">
                                  ...
                                  <li>
                                      <div className="flex items-center">
                                          <div className="w-40 h-1 bg-gray-200 rounded-full mr-2"></div>
                                          <div className="flex items-center">
                      ...
                      <div className="flex flex-col md:flex-row justify-center items-start space-x-6 mt-6">
                          <section className="max-w-sm">
                              <ul className="list-disc pl-6">
                                  ...
                                  <li>3 Find and use the nth term of the following sequences:</li>
                                  <ul>
                                      <li>(a) linear</li>
                                      <li>(b) simple quadratic</li>
                                      <li>(c) simple cubic.</li>
                                  </ul>
                              </ul>
                          </section>
                          <section className="max-w-sm">
                      ...
                      <div className="flex flex-col md:flex-row justify-center items-start space-x-6">
                          <section className="max-w-sm">
                              <ul className="list-disc pl-6">
                                  ...
                                  <li>where a and b are integer constants.</li>
                          ...
                          <section className="max-w-sm">
                              <ul className="list-disc ">
                                  ...
                                  <ul>
                                      ...
                                      <li>use and request lines in the forms x = k</li>
                                      <li>involve finding the equation when the graph is given</li>
                                  </ul>
                                  <li>ask for the gradient or y-intercept of a graph from an equation, e.g. find the gradient and y-intercept of the graph with the equation y = 6x + 3.</li>
                          ...
                          <section className="flex-1 min-h-[100px] p-4">
                              <ul className="list-disc pl-6">
                                  ...
                                  <ul>
                                      ...
                                      <li>cone</li>
                                      <li>pyramid</li>
                                      <li>sphere (term &apos;hemisphere&apos; not required)</li>
                                  </ul>
                                  <li>face</li>
                                  <li>surface</li>
                                  <li>edge.</li>
                      ...
                      <div className="flex flex-col md:flex-row justify-center items-start space-x-6 mt-6">
                          ...
                          <section className="flex-1 min-h-[100px] p-4">
                              <ul className="list-disc ">
                                  ...
                                  <li>Construction arcs must be shown.</li>
                          ...
                          <section className="flex-1 min-h-[100px] p-4">
                              <ul className="list-disc pl-6">
                                  ...
                                  <ul>
                                      ...
                                      <li>co-interior angles are equal to 180° (supplementary).</li>
                                  </ul>
                      ...
                      <div className="flex flex-col md:flex-row justify-center items-start space-x-6">
                          <section className="max-w-sm">
                              <ul className="list-disc pl-6">
                                  ...
                                  <ul>
                                      <li>1 Reflection of a shape in a vertical or horizontal line.</li>
                                      <li>2 Rotation of a shape about the origin, vertices or midpoints of edges of the shape, through multiples of 90°.</li>
                                      <li>3 Enlargement of a shape from a centre by a scale factor.</li>
                                      <li>4 Translation of a shape by a vector <span className="inline-flex items-center">
                      ...
                      <div className="flex flex-col md:flex-row justify-center items-start space-x-6">
                          <section className="max-w-sm">
                              <ul className="list-disc pl-6">
                                  ...
                                  <li>2 Calculate the probability of a single event.</li>
                          ...
                          <section className="max-w-sm">
                              <ul className="list-disc ">
                                  ...
                                  <li>e.g. The probability that a counter is blue is 0.8. What is the probability that it is not blue?</li>
                              </ul>
                          </section>
                      </div>
...
export default SubjectContentsecond