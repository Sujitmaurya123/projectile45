...
const IGCSECurriculum: React.FC= () => {
    return (
        <div className="container mx-auto px-14 py-5 text-justify max-w-6xl">
            ...
            <h2 className="text-2xl font-bold mt-4 mb-2 text-headingcol">
            ...
            <p className='mt-2 text-gray-600'>Find out more about <Link href="https://help.cambridgeinternational.org/hc/en-gb/articles/203494082-What-is-the-difference-between-IGCSE-Core-and-Extended" className='text-blue-600 cursor-pointer underline' target='_blank'>IGCSE Core and IGCSE Extended</Link>.</p>
            <p className='text-gray-600'> Source: <Link href="https://www.cambridgeinternational.org/programmes-and-qualifications/cambridge-upper-secondary/cambridge-igcse/curriculum/" className='text-blue-600 cursor-pointer underline' target='_blank'>Go to website</Link></p>
        </div>
    );
};
