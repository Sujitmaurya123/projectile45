    ...
    return (
        <div className="max-w-6xl mx-auto px-4 py-12 text-justify">
            ...
            <ul className="list-inside mb-8 text-lg text-gray-800">
                <li><strong>What to Do:</strong> Revise high-yield topics that are frequently tested.</li>
                <li><strong>What to Do:</strong> Summarize key formulas, definitions, and concepts.</li>
                <li><strong>What to Do:</strong> Use flashcards or brief notes for quick recall.</li>
            </ul>
            ...
            <ul className="list-inside mb-8 text-lg text-gray-800">
                <li><strong>What to Do:</strong> Get at least 7-8 hours of sleep to optimize cognitive function.</li>
                <li><strong>What to Do:</strong> Avoid caffeine or heavy meals close to bedtime.</li>
                <li><strong>What to Do:</strong> Establish a relaxing pre-sleep routine, such as reading light material or meditating.</li>
            </ul>
            ...
            <ul className="list-inside mb-8 text-lg text-gray-800">
                <li><strong>What to Do:</strong> Consume a balanced meal with protein, complex carbohydrates, and healthy fats.</li>
                <li><strong>What to Do:</strong> Avoid junk food and excessive sugar to prevent energy crashes.</li>
                <li><strong>What to Do:</strong> Stay hydrated but limit caffeine to avoid restlessness.</li>
            </ul>
            ...
            <ul className="list-inside mb-8 text-lg text-gray-800">
                <li><strong>What to Do:</strong> Take short walks or do light exercises.</li>
                <li><strong>What to Do:</strong> Practice deep breathing or meditation for relaxation.</li>
                <li><strong>What to Do:</strong> Engage in activities that make you happy, like listening to calming music.</li>
            </ul>
            ...
            <ul className="list-inside mb-8 text-lg text-gray-800">
                <li><strong>What to Do:</strong> Prepare your admission card, ID, pens, pencils, calculator, and any required materials.</li>
                <li><strong>What to Do:</strong> Double-check your exam venue and timings to avoid confusion.</li>
                <li><strong>What to Do:</strong> Set multiple alarms to ensure you wake up on time.</li>
            </ul>
            ...
            <ul className="list-inside mb-8 text-lg text-gray-800">
                <li><strong>What to Do:</strong> Stay off social media to avoid last-minute panic or misinformation.</li>
                <li><strong>What to Do:</strong> Use “Do Not Disturb” mode on your phone to minimize distractions.</li>
                <li><strong>What to Do:</strong> Engage in light reading or conversation with family instead of scrolling through social media.</li>
            </ul>
            ...
            <ul className="list-inside mb-8 text-lg text-gray-800">
                <li><strong>What to Do:</strong> Remind yourself of all the hard work you’ve put in.</li>
                <li><strong>What to Do:</strong> Use positive affirmations like &quot;I am prepared,&quot; &quot;I will do my best,&quot; or &quot;I am confident.&quot;</li>
                <li><strong>What to Do:</strong> Visualize yourself sitting in the exam, answering questions calmly and correctly.</li>
            </ul>
            ...
            <ul className="list-inside mb-8 text-lg text-gray-800">
                <li><strong>What to Do:</strong> Choose comfortable clothing that you’ll wear to the exam.</li>
                <li><strong>What to Do:</strong> Set a realistic wake-up time that allows for breakfast and travel.</li>
                <li><strong>What to Do:</strong> Plan your transportation and exam logistics in advance.</li>
            </ul>
