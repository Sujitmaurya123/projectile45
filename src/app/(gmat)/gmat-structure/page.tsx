...
const GMATStructure = () => {
    return (
        <div className="container mx-auto px-14 py-5 text-justify max-w-6xl">
            ...
            <h2 className="text-2xl font-semibold mt-4 text-headingcol">1. Exam Structure and Sections</h2>
            ...
            <h2 className="text-2xl font-semibold mt-4 text-headingcol">2. Section Order Selection</h2>
            ...
            <h2 className="text-2xl font-semibold mt-4 text-headingcol">3. Timing and Number of Questions</h2>
            ...
            <h2 className="text-2xl font-semibold mt-4 text-headingcol">4. Computer-Adaptive Testing</h2>
            ...
            <h2 className="text-2xl font-semibold mt-4 text-headingcol">5. Scoring and Reporting</h2>
