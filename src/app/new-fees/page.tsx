...
export default function CoachingPage() {
    ...
    useEffect(() => {
        fetch("https://ipapi.co/json/")
            ...
            .then((data) => {
                ...
                const detectedCountry = countryCodeMap[data.country_code as keyof typeof countryCodeMap] || "India";
    ...
    return (
        <div className="max-w-5xl mx-auto p-6">
            <h1 className="text-4xl font-bold mb-6 text-center text-headingcol"> Why Our Sessions Are Worth It</h1>
            ...
            {!showPricing && (
                <form onSubmit={handleSubmit} className="max-w-xl mx-auto mt-10 bg-white p-6 rounded-2xl shadow-lg space-y-6">
                    ...
                    <div className="flex flex-col space-y-2">
                        <Label htmlFor="whatsapp" className="text-lg font-medium text-gray-700">WhatsApp</Label>
                        <Input
                            name="whatsapp"
                            value={form.whatsapp}
                            onChange={handleChange}
                        ...
                        <thead>
                            <tr className="bg-green-400 text-gray-700">
                                ...
                                <th className="p-3 border border-gray-300 dark:border-gray-700">
                                    Original Price ({pricing.currency}/hour)
                                </th>
                                <th className="p-3 border border-gray-300 dark:border-gray-700">
                                    Discounted Price ({pricing.currency}/hour)
                                </th>
                            </tr>
                        </thead>
                        <tbody>
